...
#ifndef WBSCRP_CRC64_HPP
#define WBSCRP_CRC64_HPP
...
namespace scrp::crc64
{
    ...
    [[nodiscard]] constexpr uint64_t compute(const char *const data, uint64_t len, uint64_t crc = 0)
    {
        if (len == 0)
            return 0;
